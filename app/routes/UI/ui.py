...
<body>
    ...
    <aside id="sideNavSidebar" aria-label="Primary navigation">
        <div class="side-menu-list">
            ...
            <button type="button" class="side-menu-item" data-screen="setup" aria-label="Setup"><span class="nav-icon"><svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M7.2 4.8a3.1 3.1 0 0 0 3.3 4.9L18.2 17.4a1.6 1.6 0 0 1 0 2.3l-.5.5a1.6 1.6 0 0 1-2.3 0L7.7 12.5A3.1 3.1 0 0 0 2.8 9.2l2.1 2.1-1.8 1.8-2.1-2.1a3.1 3.1 0 0 0 4.2 4.2" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/><path d="M20.9 3.1a3.1 3.1 0 0 0-4.2 4.2l-2.3 2.3 2.2 2.2 2.3-2.3a3.1 3.1 0 0 0 4.2-4.2L21 7.4l-1.8-1.8 1.7-2.5Z" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span><span class="nav-label">Setup</span></button>
