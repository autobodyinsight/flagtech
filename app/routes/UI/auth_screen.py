"""Login and signup screen for authentication."""


def get_auth_screen_html():
    """Return the HTML content for the authentication screen."""
    return """
<!DOCTYPE html>
<html>
<head>
...
<body>
    <div class="auth-container">
        <div class="auth-header">
            <h1>FlagTech</h1>
            <p>Estimate Management System</p>
        </div>
        ...
        <form id="signupForm" class="auth-form" onsubmit="handleSignup(event)">
            ...
            <div class="form-group">
                ...
                <input type="text" id="signupCompany" placeholder="Your Company Name" required>
            </div>
    ...
    <script>
        const API_BASE = 'https://flagtech1.onrender.com';
